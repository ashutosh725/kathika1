...
<div>
            ...
            <div className='flex justify-end items-end mt-5'>
              <button onClick={toggleContent} className="px-6 py-3 rounded-full bg-body text-[20px] uppercase font-Yeseva" >{showMoreContent ? 'Read Less' : 'Read More'}</button>
            </div>
          </div>
          <div className='lg:w-[50%] w-full'>
            <div>
              <Image src={showMoreContent ? Story2 : Story1} alt={showMoreContent ? 'Story2' : 'Story1'} className='rounded-[40px] w-full h-full object-contain'/>
            </div>
          </div>
        </div>
      </div>
